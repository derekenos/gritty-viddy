...
export function convertPositionToIndex(col, row, width, height) {
...
export function blurFilter (pixel, params, i, col, row, data, width, height) {
  let [ level ] = params
...
export function panZoomFilter (pixel, params, i, col, row, data, width, height) {
